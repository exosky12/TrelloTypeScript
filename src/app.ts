...
const itemsContainer = $$('.items-container') as NodeListOf<HTMLDivElement>
...
function handleContainerDeletion(e: MouseEvent){
    ...
    const btnsArray = [...$$('.delete-container-btn')] as HTMLButtonElement[];
    const containers = [...$$('.items-container')] as HTMLDivElement[];
